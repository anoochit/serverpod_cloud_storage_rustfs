...
$payload''';
  ...
  Uri buildPresignedGetObjectUrl({
    required String key,
    int expiresIn = 604800,
  }) {
    final method = 'GET';
    final datetime = SigV4.generateDatetime(); // 20251218T164532Z
    final date = datetime.substring(0, 8);

    final credentialScope = '$date/$_region/$_service/aws4_request';
    ...
    final canonicalRequest =
        '''
$method
/${_bucketId}/${Uri.encodeComponent(key)}
$canonicalQuery
host:$_host
...
'''
  ...
  Future<Response> _doSignedHeadRequest({
    ...
    //   method: 'HEAD',
    // );
    // print('> _doSignedHeadRequest-uri: ${params.uri}');
    // print('> _doSignedHeadRequest-headers: ${params.headers}');
